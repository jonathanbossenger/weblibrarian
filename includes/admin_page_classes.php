...
class WEBLIB_AdminPages {
	...
	function __construct() {
		...
		$screen_id = add_submenu_page(
			'options-general.php',
			__( 'Web Librarian Configuration', 'weblibrarian' ),
			__( 'Web Librarian', 'weblibrarian' ),
			'manage_options',
			'weblibrarian-options',
		...
		$screen_id = add_menu_page(
			__( 'About the Web Librarian', 'weblibrarian' ),
			__( 'About', 'weblibrarian' ),
			'manage_circulation',
			'weblib-about',
	...
	function configuration_page() {
		...
		if ( isset( $_REQUEST['saveoptions'] ) ) {
			...
			?>
	<div id="message" class="updated fade"><?php echo $message; ?></p></div>
			<?php
	...
	<table class="form-table">
		...
		<td><select id="aws_regiondom" 
			...
			?>
				><?php _e( 'Canada', 'weblibrarian' ); ?></option>
					<option value="cn"
					<?php
					if ( $aws_regiondom == 'cn' ) {
						echo 'selected="selected"';
					...
					?>
				><?php _e( 'China', 'weblibrarian' ); ?></option>
					<option value="de"
					<?php
					if ( $aws_regiondom == 'de' ) {
						echo 'selected="selected"';
					...
					?>
				><?php _e( 'Germany', 'weblibrarian' ); ?></option>
					<option value="es"
					<?php
					if ( $aws_regiondom == 'es' ) {
						echo 'selected="selected"';
					...
					?>
							><?php _e( 'Spain', 'weblibrarian' ); ?></option>
			<option value="fr"
			<?php
			if ( $aws_regiondom == 'fr' ) {
				echo 'selected="selected"';
			...
			?>
				><?php _e( 'France', 'weblibrarian' ); ?></option>
			<option value="it"
			<?php
			if ( $aws_regiondom == 'it' ) {
				echo 'selected="selected"';
			...
			?>
				><?php _e( 'Italy', 'weblibrarian' ); ?></option>
			<option value="co.jp"
			<?php
			...
			?>
				><?php _e( 'Japan', 'weblibrarian' ); ?></option>
			<option value="co.uk"
			<?php
			...
			?>
				><?php _e( 'United Kingdom', 'weblibrarian' ); ?></option>
			<option value="com"
			<?php
			...
			?>
				><?php _e( 'United States', 'weblibrarian' ); ?></option>
		</select></td></tr>
		<tr valign="top">  
		<th scope="row">
		...
		?>
		><?php _e( 'Off', 'weblibrarian' ); ?></option>
		</select></td></tr>
	</table>
	<p>
		...
		<?php
		if ( get_option( 'weblib_debugdb' ) != 'off' ) {
			?>
		<input type="submit" name="makedb" class="button-primary"
			...
			value="<?php _e( 'Dump Database', 'weblibrarian' ); ?>" />
															<?php
		}
		?>
	</p></form></div>
	...
	function about_page() {
		...
		<p><a href="http://plugins.svn.wordpress.org/weblibrarian/assets/user_manual/user_manual.pdf">
		<?php
		_e( 'Web Librarian User Manual (PDF)', 'weblibrarian' );
		?>
		</a></p>
	...
	<div class="table">
		...
		?>
		<tr><td><?php _e( 'Total', 'weblibrarian' ); ?></td><td align="right">
							<?php
							echo $monthlyTotal;
							?>
